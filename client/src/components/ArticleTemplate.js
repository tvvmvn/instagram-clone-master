...
export default function ArticleTemplate({ article, toggleFavorite, deleteArticle }) {
      ...
      <div className="mt-2 px-2">
        <div className="flex">
          {article.isFavorite ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              onClick={() => toggleFavorite(article.slug, true)}
              viewBox="0 0 512 512"
            ...
            <svg
              className="w-6"
              onClick={() => toggleFavorite(article.slug, false)}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
          ...
          <Link to={`/p/${article.slug}/comments`} className="ml-2">
            <svg 
              className="w-6"
              xmlns="http://www.w3.org/2000/svg" 
              viewBox="0 0 512 512"
